  ...
  return (
    ...
    >
      ...
      >
        ...
        <main className="p-6 md:p-8 overflow-y-auto space-y-6 text-zinc-300">
          <p>
          ...
          <section>
            ...
            <p className="mb-4">
              El archivo debe ser un objeto JSON. Cada clave debe ser una fecha en formato <code className="bg-zinc-900 px-1 rounded">YYYY-MM-DD</code>, y su valor debe ser un objeto con los roles y nombres del personal asignado. No es necesario incluir todos los roles para cada día.
            </p>
            <pre className="bg-zinc-900/70 p-4 rounded-md border border-zinc-700 text-sm text-yellow-200 overflow-x-auto">
        ...
        <footer className="p-4 bg-zinc-900/50 border-t border-zinc-700 flex flex-wrap justify-between items-center gap-4">
          <button

  ...
  return (
    React.createElement("div", {
      ...
      React.createElement("div", {
        ...
        React.createElement("header", { className: "flex items-center justify-between p-6 border-b border-gray-700" },
        ...
        React.createElement("main", { className: "p-6 md:p-8 overflow-y-auto space-y-6 text-gray-300" },
          ...
          React.createElement("section", null,
            ...
            React.createElement("p", { className: "mb-4" },
              "El archivo debe ser un objeto JSON. Cada clave debe ser una fecha en formato ", React.createElement("code", { className: "bg-gray-900 px-1 rounded" }, "YYYY-MM-DD"), ", y su valor debe ser un objeto con los roles y nombres del personal asignado. No es necesario incluir todos los roles para cada día."
            ),
            React.createElement("pre", { className: "bg-gray-900/70 p-4 rounded-md border border-gray-700 text-sm text-yellow-200 overflow-x-auto" },
        ...
        React.createElement("footer", { className: "p-4 bg-gray-900/50 border-t border-gray-700 flex flex-wrap justify-between items-center gap-4" },
